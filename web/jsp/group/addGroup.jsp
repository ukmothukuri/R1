<%@page import="com.real.pojo.Branchmaster"%>
...
<%
    ...
    ArrayList<Branchmaster> list = dop.getAllBranches();
%>
                    ...
                    <form name="myform" class="form-inline">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input id="groupname" name="groupname" class="form-control" type="text" required placeholder="Group Name">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input id="groupcode" name="groupcode" class="form-control" type="text" required placeholder="Group Code">
                        ...
                        <div class="row clearfix">                          
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <select name="branch" id="branch" class="form-control show-tick" required>                                            
                                            <option value="0">-Select-</option>
                                            <%
                                                if (list != null) {
                                                    for (Branchmaster cm : list) {
                                            %>
                                            <option value="<%=cm.getBranchId()%>"><%=cm.getBranchName()%></option>
                                            <%
                                                    }
                                                }
                                            %>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        <label for="pt">Project type: *</label><br>                                 
                                        <input name="sales" type="radio" id="plots" class="with-gap" required><label for="plots">Sale of Plots</label>
                                        <input name="sales" type="radio" id="flats" class="with-gap"><label for="flats" class="m-l-20">Sale of Flats</label>                                        
                                    </div>
                                </div>
                            </div>
                        </div>    
                        ...
                        <div class="row clearfix">
                            <div class="col-md-4">
                                <div class="input-group">
                                    <div class="form-line">
                                        <label for="plotarea">Default Plot Area: *</label>
                                        <input id="plotarea" name="plotarea" class="form-control" type="text" required placeholder="Default Plot Area">
                                        <span id="error_plotarea" class="text-danger"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="input-group">
                                    <div class="form-line">
                                        <label for="salesarea">Sales Area (in units): *</label>
                                        <input id="salesarea" name="salesarea" class="form-control" type="text" required placeholder="Sq. Yards Sq. Feet Cents">
                                        <span id="error_salesarea" class="text-danger"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="input-group">
                                    <div class="form-line">
                                        <label for="purarea">Purchased Area (in units): *</label>
                                        <input id="purarea" name="purarea" class="form-control" type="text" required placeholder="Sq. Yards  Sq. Feet Cents">
                                        <span id="error_purarea" class="text-danger"></span>
                                    </div>
                                </div>
                            </div>                                
                        </div>
